...
def generate_launch_description():
  ...
  rviz_config_file_path = 'rviz/simple.rviz'
  xacro_file_path = 'descriptions/description.xacro'
  world_file_path = 'worlds/playtable.world'
  ...
  start_robot_state_publisher_cmd = Node(
    ...
    parameters=[{'robot_description': Command(['xacro ', xacro_model])}])
